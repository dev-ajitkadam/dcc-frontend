                    ...
                    <div className="ms-auto p-0">
                      <Dropdown align="end">
                        ...
                        <Dropdown.Menu>
                          <Dropdown.ItemText>
                            {" "}
                            <i class="bi bi-person-fill-check fs-4"></i>{ `  ${localStorage.getItem("name")}`}
                          </Dropdown.ItemText>
                          <Dropdown.ItemText className="fs-6 flex">
                          <i class="bi bi-envelope-at-fill"></i>{`${localStorage.getItem("email")}`}
                          </Dropdown.ItemText>
                          <Dropdown.Divider />
                          <Dropdown.Item>
                            <button
