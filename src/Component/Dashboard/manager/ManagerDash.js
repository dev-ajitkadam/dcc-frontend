...
import ReviewTestData from "./ReviewTestData";
import ScheduleData from "./Schedules";
import SiteEngineerAssignmentComponent from '../admin/Reports'
          ...
          <div className={`col-md-3 vh-100 d-md-flex flex-column flex-shrink-0  bg-dark shadow-sm ${isMobile && !sidebarOpen ? "sidebar-closed" : "sidebar-open"} `}>
            <div className="d-md-flex flex-column flex-shrink-0 p-2 py-2 ">
              <Link className="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
                ...
                {sidebarOpen ? (
                  <i className="bi bi-x-square bg-white p-72"></i>
                ) : (
              ...
              <ul className="nav nav-pills flex-column mb-auto" onClick={toggleSidebar}>
                ...
                <li className="nav-item form-control-lg">
                  <Link onClick={() => setNav("review")} className={`nav-link text-white ${nav === "review" && "active"}`}>
                ...
                <li className="nav-item form-control-lg">
                  <Link onClick={() => setNav("scheduleData")} className={`nav-link text-white ${nav === "scheduleData" && "active"}`}>
                  <i className="bi bi-person-lines-fill m-2"></i>
                  Schedule Data
                  </Link>
                </li>
              ...
              <button className="btn  bi bi-box-arrow-left btn-danger w-100" onClick={handleLogout}>  Logout</button>
              </div>
