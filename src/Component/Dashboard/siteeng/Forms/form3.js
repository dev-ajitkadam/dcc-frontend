...
function Form3() {
  return (
    ...
    <div className="flx">
      ...
      <h1 className="flex justify-center">DETERMINATION OF FINENESS OF FLY ASH</h1>
    ...
    <hr class="h-px my-8 bg-gray-200 border-1 dark:bg-gray-700"></hr>
        ...
        <Row className="mb-5">
          ...
          <Form.Group as={Col} controlId="formGridPassword">
            <Form.Label>Wt of Fly Ash taken (gms)</Form.Label>
        ...
        <Row className="mb-6">
          ...
          <Form.Group as={Col} controlId="formGridPassword">
            <Form.Label>Percentage of Passing</Form.Label>
        ...
        <Row className="mb-7">
          ...
          <Form.Group as={Col} controlId="formGridPassword">
            <Form.Label>WL of Fly Ash retained on 45 micron seive (gms)</Form.Label>
        ...
        <Row className="mb-8">
          ...
          <Form.Group as={Col} controlId="formGridPassword" >
            <Form.Label className='ml-30'>Average % offineness of FBy Ash</Form.Label>
        ...
        <Row className="mb-11">
          ...
          <Form.Group as={Col} controlId="formGridPassword">
            <Form.Label>FLY ASH MAKE</Form.Label>
