...
function Form8() {
  return (
    ...
    <Form.Group as={Col} controlId="formGridEmail" className="flex justify-center text-2xl">
      ...
      <p className="flex justify-center">Crush Sand  
          </p>
